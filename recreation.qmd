...
![These tables are also very close. It looks like my model identified a breakpoint (bp) for the collagen female only model at 4.3 that Sandel's teams model didn't, so my bp2 is their bp1 and my bp3 is their bp2 while their bp3 is **`NA`** .](img/table2.png)
